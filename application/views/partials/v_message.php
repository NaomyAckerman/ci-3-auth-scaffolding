<?php if ($this->session->flashdata('flash')) : ?>
	<?php if ($this->session->flashdata('type') == 'error') : ?>
		<div class="alert flex flex-row items-center bg-red-200 py-3 px-4 rounded border-b-2 border-red-300">
			...
			<div class="alert-content ml-4">
				<div class="alert-title font-semibold text-lg text-red-800">
					<?= ucfirst($this->session->flashdata('type')); ?>
				</div>
	...
	<?php elseif ($this->session->flashdata('type') == 'success') : ?>
	...
	<?php elseif ($this->session->flashdata('type') == 'warning') : ?>
